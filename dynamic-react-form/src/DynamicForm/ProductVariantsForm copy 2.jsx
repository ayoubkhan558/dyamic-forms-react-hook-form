  ...
  variants: yup.array().of(
    yup.object().shape({
      ...
      values: yup.array().of(yup.object().shape({
        value: yup.string(),
        label: yup.string(),
        code: yup.string().required('Code is required'),  // Add code property
        barcode: yup.string().required('Barcode is required'),  // Add barcode property
        availability: yup.number().required('Availability is required'),  // Add availability property
